...
export default function App() {
  ...
  function handleClick(e) {
    let likedEmojiItem = currentEmojis.find(
      (emoji) => emoji === e.target.innerHTML
    );
    let passedEmojiItem = currentEmojis.filter(
      (emoji) => emoji !== likedEmojiItem
    );

    // console.log(likedEmojiItem);
    // console.log(passedEmojiItem);

    setLikedEmojis([...likedEmojis, likedEmojiItem]);
    setPassedEmojis([...passedEmojis, passedEmojiItem]);
